curl -X GET http://localhost:5601/api/kibana/dashboards/export?dashboard=140fbf30-363e-11ea-983a-f74b5d6c2f97

curl -X POST "localhost:5601/api/kibana/dashboards/import?exclude=index-pattern" -H 'kbn-xsrf: true' -H 'Content-Type: application/json' -d'
{
  "objects": [
    {
